 ...
 <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        ...
        <tr><td>Can View Staff Stats.</td>
         ...
         <tr><td>Can <b>Manage</b> Equipment</td>
            <td>
                <input type="radio" name="can_manage_equipment"  value="1"   <?php echo $info['can_manage_equipment']?'checked="checked"':''; ?> />Yes
                &nbsp;&nbsp;
                <input type="radio" name="can_manage_equipment"  value="0"   <?php echo !$info['can_manage_equipment']?'checked="checked"':''; ?> />No
                &nbsp;&nbsp;<i>Ability to manager equipment</i>
            </td>
        </tr>
        <tr>
            <th colspan="2">
