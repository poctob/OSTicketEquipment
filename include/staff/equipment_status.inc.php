...
**********************************************************************/
if(!defined('OSTSCPINC') || !$thisstaff || !$thisstaff->canManageEquipment()) die('Access Denied');
$info=array();
$qstr='';
    ...
    <tbody>
        ...
        <tr>
            <td colspan=2>
                ...
                <br>
                <div style="padding-top:3px;"><b>Baseline</b>:&nbsp;<span class="faded">This is the default status</span></div>            
