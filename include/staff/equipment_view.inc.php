...
<strong style="font-size:16px;"><?php echo $equipment->getName() ?></strong>&nbsp;&nbsp;<span class="faded"><?php echo $equipment->isPublished()?'(Published)':''; ?></span>
</div>
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
<?php
if($thisstaff->canManageEquipment()) {
